    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Strings = new Dictionary<string, Dictionary<string, string>>
        {
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["Settings_HideDesktopIcons"] = "Hide desktop icons (cleaner desktop)",
                ["Island_DesktopTooltip"] = "Open Desktop folder",
            ...
            ["zh"] = new Dictionary<string, string>
            {
                ...
                ["Settings_HideDesktopIcons"] = "隐藏桌面图标（桌面更干净）",
                ["Island_DesktopTooltip"] = "打开桌面文件夹",
                ["Settings_Theme"] = "主题",
            ...
            ["ja"] = new Dictionary<string, string>
            {
                ...
                ["Settings_HideDesktopIcons"] = "デスクトップ アイコンを非表示（デスクトップを整理）",
                ["Island_DesktopTooltip"] = "デスクトップ フォルダーを開く",
                ["Settings_Theme"] = "テーマ",
